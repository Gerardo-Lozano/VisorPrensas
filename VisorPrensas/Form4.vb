...
Public Class Form4
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            ...
            consulta_a_sql = "SELECT * FROM ALPHA_MTY_WIRE_EXTRUSION_EX03 WHERE DATE between '" & Fecha_1 & "' and '" & Fecha_2 & "' ORDER BY WO"
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Try
            ...
            consulta_a_sql = "SELECT * FROM ALPHA_MTY_WIRE_EXTRUSION_EX03 ORDER BY WO"
